...
// ─── Event status helper ──────────────────────────────────────────────────────
// Today is April 4 2026. We mark events whose date window contains today as
// "live", and events in the next 90 days as "upcoming".
function getEventStatus(ev) {
  const today = new Date("2026-04-04T00:00:00");
  const evDate = new Date(ev.date + "T00:00:00");
  const diffDays = (evDate - today) / 86400000;
  // Treat multi-day events (HYROX runs 3–5 Apr 2026) as live if today is within 3 days of start
...
const ALL_EVENTS = [
  ...
  },
  {
    ...
    description: "AIA Singapore's inaugural AIA Ultimate FitnessFest (AUFF), presented in partnership with HYROX. The Open Edition welcomes participants of all ages and fitness levels for a 'lite' HYROX experience with guided warm-ups, curated challenges, and post-event recovery zones.",
    category: "Wellness & Fitness", color: "#ef4444",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    description: "AIA's corporate wellness run series invites company teams to compete in a 5 km fun run along the Marina waterfront. All AIA Vitality members receive bonus Vitality points for crossing the finish line together.",
    category: "Wellness & Fitness", color: "#ef4444",
  },
  {
    id: 12,
    ...
    time: "Sat, 21 Jun 2025 · 8:00 AM (International Yoga Day)",
    location: "Esplanade Park, City Hall",
    description: "Celebrate International Yoga Day with AIA Vitality. A full morning of guided flow, breathwork, and meditation led by certified AIA Vitality ambassadors. Participants earn Vitality points and receive a complimentary healthy-living kit.",
    category: "Wellness & Fitness", color: "#ef4444",
  },
  {
    id: 13,
  ...
  // ── Financial Seminars ──
  {
    ...
    description: "A deep-dive masterclass on holistic wealth planning — covering investment-linked plans, retirement annuities, and estate planning strategies tailored for Singapore residents. Led by senior AIA financial consultants and guest economists.",
  ...
  },
  {
    ...
    description: "AIA's touring Retirement Ready Roadshow brings certified financial planners to community clubs across Singapore. This edition covers CPF optimisation, supplementary retirement schemes, and AIA annuity products.",
    category: "Financial Seminars", color: "#0ea5e9",
  },
  {
    id: 22,
    ...
    description: "Designed specifically for SME owners and entrepreneurs, this half-day seminar covers key-person insurance, business succession planning, and group employee benefit schemes. Panel discussion with three Singapore business owners who have benefited from AIA's SME solutions.",
    category: "Financial Seminars", color: "#0ea5e9",
  },
  {
    id: 23,
    ...
    description: "An exclusive half-day forum designed for women at every life stage — from young professionals to retirees. AIA's all-female panel of financial planners, investment specialists, and wellness coaches tackle the unique financial challenges women face in Singapore.",
    category: "Financial Seminars", color: "#0ea5e9",
  },
  {
    id: 24,
    ...
    description: "A forward-looking seminar on the convergence of digital tools and personal finance — covering AIA's robo-advisory capabilities, investment-linked plan (ILP) fund selection, and AI-powered portfolio rebalancing. Suitable for tech-savvy investors aged 25–45.",
    category: "Financial Seminars", color: "#0ea5e9",
  },
  ...
  // ── Recruitment Drives ──
  {
    ...
    description: "Explore a rewarding career in financial advisory with AIA. This open-house Career Day features live presentations from top-performing AIA agents, a Q&A panel, and one-on-one mentoring sessions. Ideal for mid-career switchers, fresh graduates, and part-time seekers.",
  ...
  },
  {
    ...
    location: "one-north, Buona Vista",
    description: "AIA's annual Graduate Talent Hunt invites final-year university students and recent graduates to discover career pathways across actuarial science, data analytics, digital product management, and financial advisory. Speed-mentoring rounds and internship offers on the spot.",
    category: "Recruitment Drives", color: "#8b5cf6",
  },
  {
    id: 32,
    ...
    location: "Tanjong Pagar Plaza Community Club, Tanjong Pagar",
    description: "AIA's targeted hiring fair for women returning to the workforce or pivoting into financial services. Hiring managers from AIA's advisory, operations, and technology divisions will be present for direct interviews. Childcare support and flexible work arrangements are core to the AIA offer.",
    category: "Recruitment Drives", color: "#8b5cf6",
  },
  {
    id: 33,
    ...
    description: "Compact 3-hour recruitment express event for the East region. AIA district managers host group info sessions every 45 minutes, followed by breakout rooms for one-to-one career discovery consultations. Walk-ins welcome.",
    category: "Recruitment Drives", color: "#8b5cf6",
  },
  {
    id: 34,
    ...
    description: "A 2-day hackathon-style recruitment event for software engineers, data scientists, and UX designers. Participants tackle real AIA product challenges in teams of 4. Top performers receive fast-tracked interview slots and sign-on offers.",
    category: "Recruitment Drives", color: "#8b5cf6",
  },
  ...
  // ── Community Outreach ──
  {
    ...
    description: "AIA Singapore's annual Connecting Lives Volunteer Day mobilises AIA staff, insurance representatives, and the wider AIA community to serve those in need across multiple grassroots organisations.",
  ...
  },
  {
    ...
    description: "In partnership with Tottenham Hotspur FC — AIA's Global Principal Partner — the AIA Spurs Football Clinic SG60 Edition brings professional coaching to aspiring young footballers from grassroots programmes across Singapore.",
    category: "Community Outreach", color: "#22c55e",
  },
  {
    id: 43,
    ...
    description: "Free health screening and wellness assessments for seniors aged 60 and above, including blood pressure, BMI, glucose, and vision checks. AIA nurses and certified health coaches are present to advise on coverage options and supplementary shield plans.",
    category: "Community Outreach", color: "#22c55e",
  },
  {
    id: 44,
    ...
    description: "AIA's annual children's financial literacy fair introduces kids aged 6–14 to concepts of saving, spending wisely, and protecting what matters through interactive booths, mini-games, and a junior financial planner quiz with prizes.",
    category: "Community Outreach", color: "#22c55e",
  },
  {
    id: 45,
    ...
    description: "AIA staff and partners plant 500 native trees at Labrador Nature Reserve as part of Singapore's Green Singapore Day initiative. Volunteers also assist in trail maintenance, biodiversity tracking, and litter collection along the southern ridges.",
    category: "Community Outreach", color: "#22c55e",
  },
  {
    id: 2,
    ...
    description: "Rally your teams and get ready to Show It, Sweat It, and Live It — with Vitality! The #LiveWithVitality Corporate Challenge invites AIA corporate clients to complete designated activities across the season for inter-company bragging rights.",
    category: "Wellness & Fitness", color: "#ef4444",
  },
];
...
const MARATHON_ROUTES = {
  7: {
    color: "#ef4444", name: "Charity Run Route",
    waypoints: [
  ...
  13: {
    color: "#ef4444", name: "Merry-thon Trail",
    waypoints: [
  ...
  5: {
    color: "#ef4444", name: "iDiscover Walking Route",
    waypoints: [
  ...
  8: {
    color: "#ef4444", name: "Step Challenge Route",
    waypoints: [
...
if (typeof document !== "undefined" && !document.getElementById("aia-route-styles")) {
  ...
  s.textContent = `
    ...
    .marker-fire-ring {
      position:absolute; inset:-7px; border-radius:50%; z-index:2; pointer-events:none;
      background: conic-gradient(
        #ff4500 0deg, #ff6a00 45deg, #ffb300 90deg,
        #ff2200 135deg, #ff4500 180deg, #ffb300 225deg,
        #ff6a00 270deg, #ff2200 315deg, #ff4500 360deg
      );
      mask: radial-gradient(farthest-side, transparent calc(100% - 4px), #000 calc(100% - 4px));
      -webkit-mask: radial-gradient(farthest-side, transparent calc(100% - 4px), #000 calc(100% - 4px));
      animation: fireRotate 1.2s linear infinite, firePulse 0.7s ease-in-out infinite;
      filter: drop-shadow(0 0 5px #ff4500) drop-shadow(0 0 10px #ff6a00);
    }
    .marker-fire-outer {
      position:absolute; inset:-14px; border-radius:50%; z-index:1; pointer-events:none;
      background: conic-gradient(
        rgba(255,69,0,0.55) 0deg, rgba(255,106,0,0.25) 70deg, transparent 130deg,
        rgba(255,179,0,0.4) 190deg, rgba(255,69,0,0.55) 250deg, transparent 310deg, rgba(255,69,0,0.5) 360deg
      );
      animation: fireRotate 2s linear infinite reverse;
      filter: blur(4px);
    }
    .marker-fire-ping {
      position:absolute; inset:-9px; border-radius:50%; z-index:0; pointer-events:none;
      border: 2.5px solid rgba(255,69,0,0.75);
      animation: livePing 1.1s ease-out infinite;
    }
    .marker-fire-ping2 {
      position:absolute; inset:-9px; border-radius:50%; z-index:0; pointer-events:none;
      border: 2.5px solid rgba(255,150,0,0.55);
      animation: livePing 1.1s ease-out 0.55s infinite;
    }
    .marker-live-dot {
      position:absolute; top:-1px; right:-1px; width:11px; height:11px; border-radius:50%;
      background:#ff2d2d; border:2px solid #fff; z-index:10; pointer-events:none;
      box-shadow:0 0 10px #ff2d2d, 0 0 4px #fff;
    ...
    .marker-orbit-ring {
      ...
      box-shadow: 0 0 0 1px rgba(99,102,241,0.1), inset 0 0 10px rgba(99,102,241,0.07);
      animation: orbitGlow 2.2s ease-in-out infinite;
    }
    .marker-orbit-ring2 {
      position:absolute; inset:-14px; border-radius:50%; z-index:1; pointer-events:none;
      border: 1px dashed rgba(99,102,241,0.15);
      animation: orbitGlow 2.2s ease-in-out 1.1s infinite;
    }
    .marker-comet-wrap {
      position:absolute; inset:-8px; border-radius:50%; z-index:3; pointer-events:none;
      animation: cometOrbit 2.6s linear infinite;
    }
    .marker-comet-dot {
      ...
      box-shadow: 0 0 12px 4px rgba(99,102,241,0.9), 10px 0 22px 6px rgba(99,102,241,0.35);
    }
    .marker-comet-wrap2 {
      position:absolute; inset:-8px; border-radius:50%; z-index:3; pointer-events:none;
      animation: cometOrbit 4s linear infinite reverse;
    }
    .marker-comet-dot2 {
      position:absolute; top:50%; left:0;
      ...
      transform: translate(-50%, -50%);
      box-shadow: 0 0 8px 3px rgba(129,140,248,0.7), 6px 0 14px 3px rgba(129,140,248,0.3);
    }
    .marker-upcoming-badge {
      position:absolute; top:-3px; right:-3px; width:12px; height:12px; border-radius:50%;
      background: linear-gradient(135deg,#a5b4fc,#4f46e5); border:2px solid #fff;
      z-index:10; pointer-events:none;
      box-shadow: 0 0 10px rgba(99,102,241,0.9);
      animation: upcomingPop 2s ease-in-out infinite;
    }
  `;
  document.head.appendChild(s);
}
...
function PortalCard({ photo, index, scrollContainerRef, isMobile }) {
  ...
  return (
    <div ref={cardRef} style={{ display:"flex", justifyContent:index%2===0?"flex-start":"flex-end", padding:isMobile?"0 6vw":"0 10vw", marginBottom:isMobile?60:80 }}>
      <motion.div style={{ scale, opacity, y:ySpring, width:cardW, height:cardH, borderRadius:20, overflow:"hidden", position:"relative", willChange:"transform, opacity", transformOrigin:"center center" }}>
        <motion.div style={{ position:"absolute", inset:0, zIndex:2, pointerEvents:"none", background:"#000", opacity:useTransform(brightness,(b)=>Math.max(0,1-b)) }} />
...
function GalleryPage({ onClose, isMobile }) {
  ...
  return (
    <div className="gallery-page" ref={scrollRef}>
      ...
      <div className="gallery-timeline-rail"><motion.div style={{ width:"100%", background:"rgba(249,115,22,0.7)", borderRadius:2, height:railH, minHeight:4 }} /></div>
      <div style={{ position:"fixed", top:0, left:0, right:0, zIndex:50, padding:isMobile?"16px 16px 0":"20px 32px 0", display:"flex", alignItems:"flex-start", justifyContent:"space-between", pointerEvents:"none" }}>
        <div style={{ pointerEvents:"auto" }}>
          <div style={{ fontSize:isMobile?18:24, fontWeight:800, color:"#fff", letterSpacing:"-0.5px", fontFamily:"'Sora',sans-serif", lineHeight:1 }}>SG<span style={{ color:"#f97316" }}>Events</span><span style={{ fontWeight:400, color:"rgba(255,255,255,0.35)", fontSize:isMobile?13:16, marginLeft:10 }}>Gallery</span></div>
      ...
      <div style={{ paddingTop:isMobile?90:110, paddingBottom:120 }}>
        {ALL_PHOTOS.map((photo,i)=>(<PortalCard key={photo.id} photo={photo} index={i} scrollContainerRef={scrollRef} isMobile={isMobile}/>))}
      </div>
...
function EventModal({ event, onClose, isMobile }) {
  ...
  useEffect(() => {
    const onKey=(e)=>{if(e.key==="Escape")onClose();if(e.key==="ArrowRight")setMediaIdx((i)=>(i+1)%total);if(e.key==="ArrowLeft")setMediaIdx((i)=>(i-1+total)%total);};
        ...
        <div style={{ padding:isMobile?"8px 16px 12px":"24px 24px 14px" }}>
          <div style={{ display:"flex", gap:8, marginBottom:8, flexWrap:"wrap", alignItems:"center" }}>
            ...
            {getEventStatus(event) === "live" && (
              <span style={{ fontSize:10, fontWeight:800, padding:"3px 10px", borderRadius:20, background:"linear-gradient(135deg,#ff4500,#ff2d2d)", color:"#fff", letterSpacing:"1px", textTransform:"uppercase", display:"flex", alignItems:"center", gap:5, boxShadow:"0 2px 10px rgba(255,69,0,0.4)" }}>
                <span style={{ width:6, height:6, borderRadius:"50%", background:"#fff", display:"inline-block", animation:"firePulse 0.7s ease-in-out infinite" }}/>
                Live Now
              </span>
            )}
          ...
          <div style={{ display:"flex", flexWrap:"wrap", gap:isMobile?8:14 }}>
            {[{icon:"🕐",text:event.time},{icon:"📍",text:event.location}].map(({icon,text})=>(
              <span key={text} style={{ display:"flex", alignItems:"flex-start", fontSize:isMobile?12:13, color:"#555", fontWeight:500, gap:4 }}><span style={{ flexShrink:0 }}>{icon}</span><span>{text}</span></span>
            ))}
          </div>
        </div>
...
function CategoryBar({ selectedCat, onChange, isMobile }) {
  // Count live and upcoming for badges
  ...
  return (
    <div style={{
      position:"absolute", top: isMobile ? 116 : 126, left:"50%", transform:"translateX(-50%)",
      zIndex:900,
      ...
      <div className="aia-catbar" style={{ display:"flex", gap:4, overflowX:"auto" }}>
        {CATEGORIES.map((cat) => {
          ...
          const count = cat.id === "live" ? liveCount : cat.id === "upcoming" ? upcomingCount : null;
          ...
          return (
            <button
              ...
              style={{
                ...
                borderRadius:30, border: isActive ? "none" : (isLive || isUpcoming) ? `1px solid ${cat.color}40` : "none",
                cursor:"pointer",
                fontSize: isMobile ? 10 : 12, fontWeight:700,
                letterSpacing:"0.2px",
                display:"flex", alignItems:"center", gap:5,
                background: isActive ? activeBg : idleBg,
                color: isActive ? "#fff" : (isLive || isUpcoming) ? cat.color : "#666",
                boxShadow: isActive ? activeShadow : "none",
                position: "relative",
              }}
            >
              {/* Pill icon — Live uses animated dot when idle, others use emoji */}
              {isLive && !isActive && (
                <span style={{ width:7, height:7, borderRadius:"50%", background:"#ff2d2d", display:"inline-block", flexShrink:0, boxShadow:"0 0 6px #ff2d2d", animation:"firePulse 0.8s ease-in-out infinite" }}/>
              )}
              {(!isLive || isActive) && (
              ...
              {count !== null && count > 0 && (
                <span style={{
                  ...
                  background: isActive ? "rgba(255,255,255,0.25)" : (isLive ? "#ff2d2d" : "#6366f1"),
                  color:"#fff", marginLeft:1, lineHeight:1.4, letterSpacing:"0.2px",
                }}>{count}</span>
              )}
            </button>
          );
...
// ─── Date Bar ─────────────────────────────────────────────────────────────────
function DateBar({ selectedDate, onChange, isMobile, visibleEvents }) {
  const isAll = selectedDate === "all";
  const relevantDates = [...new Set(visibleEvents.map((e) => e.date))].sort();
  return (
    <div style={{
      position:"absolute", top:isMobile?68:76, left:"50%", transform:"translateX(-50%)",
      zIndex:900,
      background:"rgba(255,255,255,0.94)", backdropFilter:"blur(16px)",
      borderRadius:40, padding:"5px 7px",
      boxShadow:"0 4px 20px rgba(0,0,0,0.11)",
      ...
      <div className="aia-datebar" style={{ display:"flex", gap:3, overflowX:"auto" }}>
        <button onClick={() => onChange("all")} style={{ flexShrink:0, padding:isMobile?"5px 10px":"6px 14px", borderRadius:30, border:"none", cursor:"pointer", fontSize:isMobile?11:12, fontWeight:700, letterSpacing:"0.3px", transition:"all 0.2s", background:isAll?"linear-gradient(135deg,#f97316,#ef4444)":"transparent", color:isAll?"#fff":"#666", boxShadow:isAll?"0 2px 10px rgba(249,115,22,0.4)":"none", display:"flex", alignItems:"center", gap:4 }}>
        ...
        {relevantDates.map((date) => {
          const eventsOnDay = visibleEvents.filter((e) => e.date === date);
...
function MobileBottomSheet({ events, onSelect, isOpen, onToggle }) {
  const byDate = UNIQUE_DATES.reduce((acc,d)=>{ const evs=events.filter((e)=>e.date===d); if(evs.length)acc[d]=evs; return acc; },{});
  return (
    <>
      <button onClick={onToggle} style={{ position:"absolute", bottom:isOpen?"52vh":24, left:"50%", transform:"translateX(-50%)", zIndex:901, border:"none", cursor:"pointer", background:"linear-gradient(135deg,#f97316,#ef4444)", color:"#fff", borderRadius:30, padding:"8px 18px", fontSize:12, fontWeight:700, letterSpacing:"0.3px", boxShadow:"0 4px 20px rgba(249,115,22,0.45)", display:"flex", alignItems:"center", gap:6, transition:"bottom 0.35s cubic-bezier(.4,0,.2,1)" }}>
        ...
        {TIMELINE_MILESTONES.map((m,i)=>{
          ...
          return (
            <div key={i} style={{ display:"flex", justifyContent:isMobile?"flex-start":(isLeft?"flex-start":"flex-end"), marginBottom:isMobile?60:100, paddingLeft:isMobile?44:0 }}>
              <div style={{ position:"absolute", left:isMobile?12:"calc(50% - 8px)", width:19, height:19, borderRadius:"50%", background:m.color, border:"3px solid #fff", boxShadow:`0 0 0 2px ${m.color}55`, marginTop:22, zIndex:2, flexShrink:0 }}/>
              <motion.div initial={{ opacity:0, x:isMobile?30:(isLeft?-50:50) }} whileInView={{ opacity:1, x:0 }} viewport={{ once:false, amount:0.4, root:containerRef }} transition={{ duration:0.7, ease:[0.16,1,0.3,1] }} style={{ width:isMobile?"100%":"44%", background:"#f9fafb", borderRadius:16, padding:isMobile?"16px 18px":"22px 26px", boxShadow:"0 8px 32px rgba(0,0,0,0.06)", border:`1.5px solid ${m.color}22`, position:"relative" }}>
                ...
                <div style={{ fontSize:isMobile?14:16, fontWeight:700, color:"#111", margin:"6px 0 8px", letterSpacing:"-0.2px" }}>{m.title}</div>
...
function CorridorNode({ item, index, total }) {
  ...
  const start=index/total, end=(index+1)/total, span=end-start;
...
function CorridorProgress({ total }) {
  ...
  useEffect(()=>{ return scrollYProgress.on("change",(v)=>{ setActive(Math.min(total-1,Math.floor(v*total))); }); },[scrollYProgress,total]);
  return (
    <div style={{ position:"absolute", right:24, top:"50%", transform:"translateY(-50%)", display:"flex", flexDirection:"column", gap:10, alignItems:"center" }}>
      {CORRIDOR_MILESTONES.map((m,i)=>(<div key={i} style={{ width:i===active?8:5, height:i===active?8:5, borderRadius:"50%", background:i===active?m.color:"rgba(255,255,255,0.2)", transition:"all 0.3s", boxShadow:i===active?`0 0 8px ${m.color}`:"none" }}/>))}
...
export default function App() {
  ...
  // Filter by category/status first, then date
  ...
  const visibleEvents = selectedDate === "all" ? catFiltered : catFiltered.filter((e) => e.date === selectedDate);

  // Reset date when switching categories if no events match
  useEffect(() => {
    const datesInCat = [...new Set(catFiltered.map((e) => e.date))];
    if (selectedDate !== "all" && !datesInCat.includes(selectedDate)) setSelectedDate("all");
  }, [selectedCat]);
  ...
  useEffect(() => { if(leafletRef.current)leafletRef.current.setZoom(isMobile?11:12); }, [isMobile]);
  ...
  useEffect(() => {
    ...
    routeEvents.forEach((ev) => {
      ...
      const totalSteps=28, segLengths=[];
      let totalLen=0;
      for(let i=0;i<pts.length-1;i++){const dlat=pts[i+1][0]-pts[i][0],dlng=pts[i+1][1]-pts[i][1];const len=Math.sqrt(dlat*dlat+dlng*dlng);segLengths.push(len);totalLen+=len;}
      const interpolated=[];
      for(let s=0;s<totalSteps;s++){
        const t=(s/(totalSteps-1))*totalLen;let acc=0;
        for(let i=0;i<segLengths.length;i++){
          if(acc+segLengths[i]>=t||i===segLengths.length-1){
            ...
            const side=s%2===0?1:-1;const perpRad=(bearing+90)*(Math.PI/180);const offset=0.00018*side;
      ...
      const footSVG=(color)=>`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 26" width="18" height="26"><ellipse cx="9" cy="19" rx="7" ry="7" fill="${color}" opacity="0.85"/><ellipse cx="9" cy="10" rx="5" ry="6" fill="${color}" opacity="0.85"/><ellipse cx="5.5" cy="4.5" rx="2.8" ry="3" fill="${color}" opacity="0.75"/><ellipse cx="12.5" cy="4.5" rx="2.8" ry="3" fill="${color}" opacity="0.75"/><ellipse cx="3" cy="8" rx="2" ry="2.2" fill="${color}" opacity="0.6"/><ellipse cx="15" cy="8" rx="2" ry="2.2" fill="${color}" opacity="0.6"/></svg>`;
      interpolated.forEach(({lat,lng,bearing,idx})=>{
        const delay=idx*120;
        const timer=setTimeout(()=>{
          const rot=Math.round(bearing);
          const el=document.createElement("div");
          el.className="aia-footprint";el.style.setProperty("--rot",`${rot}deg`);el.style.transform=`rotate(${rot}deg)`;
          el.style.animationDelay="0ms";el.style.animationDuration="2.4s";el.innerHTML=footSVG(route.color);
          ...
          const intervalId=setInterval(()=>{ el.style.animation="none";void el.offsetWidth;el.style.animation="footAppear 2.4s ease-out forwards"; },loopInterval);
    ...
    const markerSize=isMobile?42:54, markerHoverSize=isMobile?66:84, markerOffset=isMobile?-12:-15;
    visibleEvents.forEach((ev)=>{
      const status = getEventStatus(ev);

      // Outer wrapper — extra padding to make room for rings without clipping
      const ringPad = status === "live" ? 18 : status === "upcoming" ? 18 : 0;
      ...
      // ── Fire ring decorations ──────────────────────────────────────────────
      if (status === "live") {
        const ping1 = document.createElement("div"); ping1.className = "marker-fire-ping";  wrapper.appendChild(ping1);
        const ping2 = document.createElement("div"); ping2.className = "marker-fire-ping2"; wrapper.appendChild(ping2);
        const outer = document.createElement("div"); outer.className = "marker-fire-outer"; wrapper.appendChild(outer);
        const ring  = document.createElement("div"); ring.className  = "marker-fire-ring";  wrapper.appendChild(ring);
      }

      // ── Comet orbit decorations ────────────────────────────────────────────
      if (status === "upcoming") {
        const glow  = document.createElement("div"); glow.className  = "marker-comet-glow";  wrapper.appendChild(glow);
        const ring  = document.createElement("div"); ring.className  = "marker-orbit-ring";  wrapper.appendChild(ring);
        const ring2 = document.createElement("div"); ring2.className = "marker-orbit-ring2"; wrapper.appendChild(ring2);
        // comet 1
        const cw1 = document.createElement("div"); cw1.className = "marker-comet-wrap";
        const cd1 = document.createElement("div"); cd1.className = "marker-comet-dot"; cw1.appendChild(cd1); wrapper.appendChild(cw1);
        // comet 2 (counter-rotating smaller)
        const cw2 = document.createElement("div"); cw2.className = "marker-comet-wrap2";
        const cd2 = document.createElement("div"); cd2.className = "marker-comet-dot2"; cw2.appendChild(cd2); wrapper.appendChild(cw2);
      }
      ...
      img.src=ev.thumbnail;img.style.cssText="width:100%;height:100%;object-fit:cover;display:block;pointer-events:none;";
      container.appendChild(img);

      // Status badge (live dot / upcoming dot)
      if (status === "live") {
      ...
      // Date badge when showing all dates
      if(selectedDate==="all"){
      ...
      wrapper.addEventListener("mouseenter",()=>{ container.style.width=markerHoverSize+"px";container.style.height=markerHoverSize+"px";container.style.boxShadow=`0 8px 36px ${borderColor}99`;container.style.borderWidth="4px";container.style.zIndex="999"; });
      wrapper.addEventListener("mouseleave",()=>{ container.style.width=markerSize+"px";container.style.height=markerSize+"px";container.style.boxShadow=boxShadow;container.style.borderWidth="3px";container.style.zIndex="5"; });
  ...
  return (
    <div style={{ width:"100vw", height:"100vh", fontFamily:"'Sora',sans-serif", position:"relative", overflow:"hidden" }}>
      ...
      {/* ── Date Bar ── */}
      <DateBar selectedDate={selectedDate} onChange={setSelectedDate} isMobile={isMobile} visibleEvents={catFiltered} />

      {/* ── Category Filter Bar ── */}
      <CategoryBar selectedCat={selectedCat} onChange={(cat) => { setSelectedCat(cat); setSelectedDate("all"); }} isMobile={isMobile} />

      {/* ── Mobile bottom sheet (shown when "all" dates + "all" cats) ── */}
      {isMobile && (
        <MobileBottomSheet
      ...
      {visibleEvents.length === 0 && (
        <div style={{ position:"absolute", top:"50%", left:"50%", transform:"translate(-50%,-50%)", zIndex:800, background:"rgba(255,255,255,0.96)", borderRadius:20, padding:"24px 28px", textAlign:"center", boxShadow:"0 8px 32px rgba(0,0,0,0.12)", width:"80%", maxWidth:320 }}>
          ...
          <div style={{ fontSize:12, color:"#888", marginTop:4 }}>
            {selectedCat==="live" ? "Check back soon — events go live on their start date" : selectedCat==="upcoming" ? "Events within the next 90 days will appear here" : "Try a different category or date"}
          </div>
        </div>
      )}
