...
function TimelinePage({ onClose, isMobile }) {
  ...
  return (
    <div style={{
      ...
      background: "#fff", overflowY: "auto", fontFamily: "'Sora', sans-serif",
    }} ref={containerRef}>
      ...
      <button onClick={onClose} style={{
        ...
        justifyContent: "center", color: "#333", boxShadow: "0 2px 12px rgba(0,0,0,0.1)",
      }}>
      ...
      <div style={{ textAlign: "center", padding: isMobile ? "60px 20px 40px" : "80px 20px 60px" }}>
        <div style={{ fontSize: isMobile ? 28 : 42, fontWeight: 800, color: "#111", letterSpacing: "-1px", lineHeight: 1.1 }}>
          Walk With <span style={{ color: "#d31145" }}>AIA</span>
        </div>
        <div style={{ fontSize: isMobile ? 13 : 15, color: "#888", marginTop: 10, fontWeight: 500 }}>
          A 95-Year Legacy of Impact
        </div>
      </div>
          ...
          return (
            <div key={i} style={{
              ...
              <div style={{
                ...
                boxShadow: `0 0 0 2px ${m.color}55`,
                marginTop: 22,
                zIndex: 2,
                flexShrink: 0,
              }} />
...
function CorridorNode({ item, index, total }) {
  ...
  return (
    <motion.div style={{
      ...
      x: isLeft ? "-150%" : "50%", y: "-50%",
      z, scale, opacity,
      width: 360, willChange: "transform, opacity",
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 2000, fontFamily: "'Sora', sans-serif" }}>
      ...
      <div style={{
        ...
        perspective: "1200px",
        background: "radial-gradient(ellipse at center, #1a1a2e 0%, #04040a 100%)",
        display: "flex", alignItems: "center", justifyContent: "center",
        ...
        <div style={{
          ...
          backgroundImage: [
            "linear-gradient(to right, rgba(211,17,69,0.07) 1px, transparent 1px)",
            "linear-gradient(to bottom, rgba(211,17,69,0.07) 1px, transparent 1px)",
          ].join(","),
        ...
        {/* Photo nodes */}
        {CORRIDOR_MILESTONES.map((item, i) => (
          <CorridorNode key={i} item={item} index={i} total={total} />
        ))}
      ...
      <button onClick={onClose} style={{
        ...
        display: "flex", alignItems: "center", justifyContent: "center",
        color: "rgba(255,255,255,0.7)", backdropFilter: "blur(12px)",
        pointerEvents: "auto",
      }}>
        <svg viewBox="0 0 24 24" width="14" height="14" stroke="currentColor" strokeWidth="2.5" fill="none">
          <line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" />
      ...
      {/* Fixed header label */}
      <div style={{
        position: "fixed", top: 20, left: "50%", transform: "translateX(-50%)", zIndex: 3,
        textAlign: "center", pointerEvents: "none",
      }}>
        <div style={{ fontSize: isMobile ? 16 : 20, fontWeight: 800, color: "#fff", letterSpacing: "-0.4px" }}>
          AIA <span style={{ color: "#d31145" }}>Corridor</span>
        </div>
        <div style={{ fontSize: 10, color: "rgba(255,255,255,0.3)", letterSpacing: "2px", textTransform: "uppercase", marginTop: 2 }}>
          Through Time
        </div>
      </div>
    </div>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        letterSpacing: "1px", marginTop: 6, fontWeight: 600,
        writingMode: "vertical-rl",
      }}>
        {CORRIDOR_MILESTONES[active]?.year}
      </div>
    </div>
  );
}
    ...
    <div style={{ width: "100vw", height: "100vh", fontFamily: "'Sora', sans-serif", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{
        ...
        <button
          ...
          title="AIA Corridor — scroll through time"
          style={{
            width: 48, height: 48, borderRadius: "50%", border: "none", cursor: "pointer",
            background: "linear-gradient(135deg,#d31145,#7c0828)",
            boxShadow: "0 4px 18px rgba(211,17,69,0.55)",
            display: "flex", alignItems: "center", justifyContent: "center",
            transition: "transform 0.2s, box-shadow 0.2s",
          }}
        ...
        >
          <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            ...
            <circle cx="12" cy="6"  r="2.5" fill="white" stroke="none" />
